...
abstract class BaseFactory
{
    ...
    public static function make(
        ...
        if (is_numeric($makeParameter)) {
            trigger_error(
                static::class . '::make($times) is deprecated. Use ::make()->times($times) instead.',
                E_USER_DEPRECATED,
            );
        ...
        if ($times !== 1 && !is_numeric($makeParameter)) {
            trigger_error(
                static::class . '::make($data, $times) is deprecated. Use ::make($data)->times($times) instead.',
                E_USER_DEPRECATED,
            );
        }
    ...
    {
        trigger_error(
            static::class . '::setTimes() is deprecated. Use ::times() instead.',
            E_USER_DEPRECATED,
        );
